...
contributors = [
    {
        ...
        "photo": "https://github.com/apatil210/LDRD2/blob/main/Akashpic1.JPG",
    },
    {
...
st.markdown(
    ...
    <section class="section">
        ...
        <p class="section-copy">The project team includes researchers and technical leaders contributing expertise in industrial systems, energy analysis, and policy-relevant modeling.</p>
